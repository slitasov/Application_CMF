...
def s_volume_imbalance(system_params, substep, state_history, previous_state, policy_input):
    volume_parameter = policy_input['volume_parameter']

    return "volume_parameter", volume_parameter
